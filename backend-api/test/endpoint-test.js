...
describe("/GET top-X-of-Y", () => {
  ...
  it("it should return 200", done => {
    ...
    const expectedResult = [
      { "_id": "59f5d5a5dfa15819497c7bc0", "authors": [{ "ids": ["1747337"], "name": "Damien Chablat" }, { "ids": ["1750119"], "name": "Jorge Angeles" }] },
      { "_id": "59f5d5acdfa15819497d4668", "authors": [{ "ids": ["1776683"], "name": "Liang Ma" }, { "ids": ["1747337"], "name": "Damien Chablat" }] },
      { "_id": "59f5d5afdfa15819497db2d6", "authors": [{ "ids": ["1749917"], "name": "Daniel Kanaan" }, { "ids": ["1732597"], "name": "Philippe Wenger" }, { "ids": ["1747337"], "name": "Damien Chablat" }] }
    ];
  ...
  it("it should return 200", done => {
    ...
    const expectedResult = [
      { "_id": "59f5d5b6dfa15819497e88b9", "keyPhrases": ["Grammar", "CNN", "Chunking", "Convex", "NOUN"] },
      { "_id": "59f5d5b6dfa15819497e892e", "keyPhrases": ["XOR", "Binary", "CNN", "Circuit Design", "Adder Circuit"] },
      { "_id": "59f5d5b6dfa15819497e8936", "keyPhrases": ["CNN", "Termination", "Recursion", "Convex", "Terminating Function"] },
      { "_id": "59f5d5b6dfa15819497e89f4", "keyPhrases": ["Witness", "Worst-case", "Number Of Edge", "Vertices U", "K Edges"] },
      { "_id": "59f5d5b6dfa15819497e9024", "keyPhrases": [] }
    ];
  ...
  it("it should return 200", done => {
    ...
    const expectedResult = [
      { "_id": "59f5d5b6dfa15819497e8b3d", "authors": [{ "ids": ["2378382"], "name": "Andreas Darmann" }], "id": "827b9d00200d2aedcf942230b1aad5f9b06e5776", "inCitations": ["7d12e1978c504b00e23af34e5edeb498536b1c23", "2c3903c7a53e5aa21de91aac40882c7638635b61", "507e8c35890f2be08416df4538c379c1f1cc2f63", "9d86a7016b083838b518cb368c4631c20c817cb2"], "keyPhrases": ["Balanced Allocation"], "outCitations": [], "title": "Proportional Borda allocations", "venue": "Social Choice and Welfare", "year": 2016 },
      { "_id": "59f5d5b6dfa15819497e8b41", "authors": [{ "ids": ["5302058"], "name": "Hasan Göçer" }], "id": "82828bced68f4d037f0cc4d68d33d9e1d5318c68", "inCitations": [], "keyPhrases": [], "outCitations": [], "title": "Comparison of treatment", "venue": "Nigerian medical journal", "year": 2016 },
      { "_id": "59f5d5b6dfa15819497e8b43", "authors": [{ "ids": ["5018653"], "name": "Kara Hanson" }], "id": "827d66ab33c470a205d6564740be249087b68c19", "inCitations": [], "keyPhrases": ["District",], "outCitations": ["b3b1144bc9029349ec19fdb37acd1b077130e3ac"], "title": "Commentary—District decision-making", "venue": "Health policy and planning", "year": 2016 },
      { "_id": "59f5d5b6dfa15819497e8b64", "authors": [{ "ids": ["2978859"], "name": "Lorenzo Villarroel" }], "id": "82b5dcc4cd85f04fb16027880735c0ebe1fa817c", "inCitations": ["c2ed14a38d555bb912496d79909c89174b603bb2", "b54e8a66a5641485fd04178eaab4bdaec16f9190"], "keyPhrases": ["APP"], "outCitations": [], "title": "Release planning of mobile apps based on user reviews", "venue": "ICSE", "year": 2016 },
      { "_id": "59f5d5b6dfa15819497e8b77", "authors": [{ "ids": [], "name": "Rahmatollah Marzband" }], "id": "82ddf6b6c2930970dc9469118b0893f5ad12dfa5", "inCitations": [], "keyPhrases": ["Spiritual Care"], "outCitations": ["41ff0ca947d6e03bd56fb82bce51edfe3bcbcc0d"], "title": "A Concept Analysis", "venue": "", "year": 2016 }
    ];
  ...
  it("it should return 200", done => {
    ...
    const expectedResult = [
      { "_id": "59f5d5b5dfa15819497e5fe4", "keyPhrases": ["MNO", "CYS", "HPV", "TEM", "Ctivity"] },
      { "_id": "59f5d5b6dfa15819497e7637", "keyPhrases": ["3D Face", "GST", "2D Face Images", "Arbitrary View", "Regressor"] },
      { "_id": "59f5d5b6dfa15819497e8724", "keyPhrases": ["MHH", "Pub/sub", "HPV", "Broker", "Subscriber"] },
      { "_id": "59f5d5b6dfa15819497e8aa7", "keyPhrases": ["HPV", "GST", "Relay"] }
    ];
  ...
  it("it should return 200", done => {
    ...
    const expectedResult = [
      { "_id": "59f5d5a9dfa15819497ce9b0", "authors": [{ "ids": ["2200197"], "name": "Yingda Chen" }, { "ids": ["3212767"], "name": "Shalinee Kishore" }, { "ids": ["1742253"], "name": "Jing Li" }] }
    ];
